  ...
  return (
    <div>
      <div className="input-box mt-5 ">
        <input type="search" name="search-form" id="search-form" className="search-input" onChange={(e) => setSearchItem(e.target.value)} placeholder="Search Items" value={searchItem} />
